      ...
      <div className="min-h-screen bg-dot-pattern">
          ...
          <div className="max-w-[1100px] mx-auto">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(30px,4vw,48px)] font-extrabold tracking-tight leading-[1.1] mb-5">Kocaeli Silobas & Hafriyat</h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  Kocaeli ve Gebze'de silobas taşımacılığı ve hafriyat tedariği ile Dilovası, GOSB ve sanayi bölgelerine hızlı teslimat sunuyoruz. Çimento, kalsit, kum, mıcır ve tüm inşaat malzemeleri için online teklif alın.
                </p>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            ...
            <p className="text-sm text-txt-2 mb-6 max-w-[600px]">
              Kocaeli, Gebze, Dilovası ve GOSB bölgesinde silobas ve hafriyat hizmeti veriyoruz.
            </p>
            <div className="grid md:grid-cols-2 gap-5">
              <div className="border border-border rounded-2xl p-6 bg-background hover:border-accent-border transition-colors">
                ...
                <p className="text-sm text-txt-2 leading-relaxed">
                  Çimento, kalsit, uçucu kül, kireç, mermer tozu, alçı ve tüm toz/granül malzemeleri pnömatik silobas araçlarıyla Kocaeli ve Gebze genelinde teslim ediyoruz. Dilovası ve GOSB sanayi tesislerine kapalı sistem boşaltma.
                </p>
              ...
              <div className="border border-border rounded-2xl p-6 bg-background hover:border-accent-border transition-colors">
                ...
                <p className="text-sm text-txt-2 leading-relaxed">
                  Kum, çakıl, mıcır, stabilize malzeme ve hafriyat tedariği. Gebze, Dilovası ve GOSB çevresine şantiye teslimatı. Damperli araçlarla hızlı teslimat.
                </p>
        ...
        <section className="py-16 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            ...
            <p className="text-sm text-txt-2 mb-8 max-w-[520px]">Kocaeli'de tedarik ettiğimiz malzemeler. Detay için malzeme sayfalarına göz atın.</p>
