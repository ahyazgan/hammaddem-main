...
const canonical = "https://hammaddem.co/hizmet-bolgeleri/yalova";
const title = "Yalova Silobas Nakliye & Hammadde Teslimatı | Hammaddem";
const description = "Yalova'da silobas nakliye ve hammadde teslimatı: dökme çimento, kalsit, kum, çakıl, mıcır. Sanayi bölgeleri ve inşaat projelerine teslimat, 30 dk teklif.";
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  { name: "Ana Sayfa", url: "/" },
  { name: "Hizmet Bölgeleri", url: "/hizmet-bolgeleri/yalova" },
  { name: "Yalova Silobas Nakliye & Hammadde Teslimatı", url: "/hizmet-bolgeleri/yalova" },
]);

const BolgeYalova = () => {
  const digerSehirler = BOLGE_ROUTES.filter((r) => r.path !== "/hizmet-bolgeleri/yalova");

  const localBusinessJsonLd = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "Hammaddem – Yalova Silobas Nakliye & Hammadde Teslimatı",
    description,
    url: canonical,
    telephone: "+905393308617",
    areaServed: { "@type": "City", name: "Yalova", containedInPlace: { "@type": "Country", name: "Türkiye" } },
  };

  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Yalova Silobas Nakliye ve Hammadde Teslimatı",
    description,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="yalova silobas, silobas yalova, yalova silobas nakliye, yalova çimento, yalova kum fiyatları, yalova çakıl, yalova mıcır, yalova hammadde teslimatı" />
      ...
      <div className="min-h-screen bg-dot-pattern">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(30px,4vw,48px)] font-extrabold tracking-tight leading-[1.1] mb-5">
                  Yalova Silobas Nakliye ve Hammadde Teslimatı
                </h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  Yalova'da silobas nakliye ve hammadde teslimatı: dökme çimento, kalsit, kum, çakıl, mıcır. Sanayi bölgeleri ve inşaat projelerine teslimat, 30 dk teklif.
                </p>
                ...
                <p className="mt-5 text-sm text-txt-2">
                  ...
                  <Link to="/hafriyat/yalova" className="font-semibold text-navy no-underline hover:underline">
                    Yalova hafriyat firması sayfası →
                  </Link>
                </p>
              </div>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">Yalova&apos;da Hizmetlerimiz</h2>
            <div className="prose prose-sm max-w-none text-txt-2 leading-[1.8] space-y-4">
              <p>Yalova, İstanbul ve Bursa arasındaki stratejik konumuyla Marmara Denizi&apos;nin güney kıyısında yer alır. Yalova Organize Sanayi Bölgesi ve Taşköprü Sanayi Sitesi başta olmak üzere kimya, plastik ve gıda sektörlerine çimento, kalsit, kireç, alçı, mermer tozu ve uçucu kül silobas taşımacılığı yapıyoruz.</p>
              <p>Yalova&apos;nın feribot bağlantısı sayesinde İstanbul&apos;dan hızlı erişim avantajıyla kum, çakıl, mıcır ve stabilize malzeme tedariği sağlıyoruz. Termal turizm yatırımları ve konut projelerine de düzenli malzeme teslimatı yapıyoruz.</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">Yalova Hizmet Detayı</h2>
            <div className="grid md:grid-cols-2 gap-5">
              <div className="border border-border rounded-2xl p-6 bg-background hover:border-accent-border transition-colors">
                ...
                <p className="text-sm text-txt-2 leading-relaxed mb-2">
                  Çimento, kalsit, uçucu kül, kireç, mermer tozu, alçı ve tüm toz/granül malzemeleri pnömatik silobas araçlarıyla Yalova genelinde teslim ediyoruz.
                </p>
                <p className="text-xs text-txt-2 leading-relaxed mb-3">
                  <strong>Hizmet bölgeleri:</strong> Yalova OSB, Taşköprü Sanayi Sitesi, Altınova
                </p>
              ...
              <div className="border border-border rounded-2xl p-6 bg-background hover:border-accent-border transition-colors">
                ...
                <p className="text-sm text-txt-2 leading-relaxed mb-2">
                  Kum, çakıl, mıcır, stabilize malzeme tedariği. Yalova ilçelerinde şantiye ve tesislere damperli araçlarla teslimat.
                </p>
                <p className="text-xs text-txt-2 leading-relaxed mb-3">
                  <strong>İlçeler:</strong> Merkez, Altınova, Çiftlikköy, Çınarcık, Termal, Armutlu
                </p>
                <Link to="/hafriyat/yalova" className="inline-flex items-center gap-1 text-sm font-semibold text-primary mt-1 no-underline hover:underline">
                  Yalova hafriyat işleri: kazı, moloz <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-3">Yalova&apos;da Taşıdığımız Malzemeler</h2>
            <p className="text-sm text-txt-2 mb-8 max-w-[520px]">Detay ve fiyat için malzeme sayfasına tıklayın, Yalova&apos;ya özel teklif alın.</p>
        ...
        <section className="py-16 md:py-20 px-4 md:px-10 bg-off">
          <div className="max-w-[700px] mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-4">Yalova İçin Teklif Alın</h2>
