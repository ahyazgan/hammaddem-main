...
const canonical = "https://hammaddem.co/malzeme/mermer-tozu/kocaeli";
const title = "Kocaeli Mermer Tozu Silobas Taşıma | Hammaddem";
const description = "Kocaeli'da mermer tozu silobas taşıma. Gebze, Dilovası, GOSB ve Kocaeli genelinde hızlı teslimat. Ton bazında rekabetçi fiyat, 30 dakikada online teklif alın.";

const comboFaq = [
  {
    "q": "Kocaeli'da Mermer Tozu silobas taşıma nasıl çalışır?",
  ...
  {
    "q": "Kocaeli'da Mermer Tozu için minimum sipariş miktarı nedir?",
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Kocaeli Mermer Tozu Taşıma", url: "/malzeme/mermer-tozu/kocaeli" },
]);

const faqJsonLd = buildFaqJsonLd(comboFaq);


const MalzemeMermerTozuKocaeli = () => {
  const localBusinessJsonLd = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "Hammaddem – Kocaeli Mermer Tozu Tedariği",
    description,
    url: canonical,
  ...
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Kocaeli Mermer Tozu Silobas Taşıma",
    description,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="kocaeli mermer tozu, mermer tozu kocaeli, kocaeli mermer-tozu fiyatı, mermer unu, CaCO3" />
      ...
      <div className="min-h-screen bg-dot-pattern">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(28px,4vw,46px)] font-extrabold tracking-tight leading-[1.1] mb-5">
                  Kocaeli&apos;da Mermer Tozu Silobas Taşıma
                </h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  Kocaeli'da mermer tozu silobas taşıma için Hammaddem'i tercih edin. Gebze, Dilovası, GOSB ve Kocaeli genelinde mermer tozu teslimatı yapıyoruz. Ton bazında rekabetçi fiyat için 30 dakika içinde teklif alın.
                </p>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">
              Kocaeli&apos;da Mermer Tozu Silobas Taşıma Nasıl Çalışır?
            </h2>
            <div className="prose prose-sm max-w-none text-txt-2 leading-[1.8] space-y-4">
              <p>
                Kocaeli&apos;da mermer tozu silobas taşıma için Hammaddem platformunu kullanın.
                Gebze, Dilovası, GOSB ve Kocaeli genelinde mermer tozu teslimatı gerçekleştiriyoruz.
        ...
        <section className="py-16 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-10">
              Kocaeli&apos;da Mermer Tozu İçin Neden Hammaddem?
            </h2>
        ...
        <section className="py-16 md:py-20 px-4 md:px-10 bg-off">
          <div className="max-w-[700px] mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-4">
              Kocaeli Mermer Tozu İçin Teklif Alın
            </h2>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-3">Kocaeli Mermer Tozu Taşıma Hakkında Sık Sorulan Sorular</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <a key="ucucu-kul" href="/malzeme/ucucu-kul/kocaeli" className="px-3 py-1.5 rounded-full text-xs font-medium bg-background border border-border hover:border-accent-border hover:text-primary transition-colors no-underline">Uçucu Kül</a>
                </div>
              </div>
            </div>
          </div>
...
export default MalzemeMermerTozuKocaeli;
