...
const canonical = "https://hammaddem.co/malzeme/cakil/ankara";
const title = "Ankara Çakıl Satış & Teslimat | Hammaddem";
const description = "Ankara'da çakıl satış ve teslimat. OSB, Ostim ve sanayi bölgelerine hızlı teslimat. Ton bazında rekabetçi fiyat, 30 dakikada online teklif alın.";

const comboFaq = [
  {
    "q": "Ankara'da Çakıl silobas taşıma nasıl çalışır?",
  ...
  {
    "q": "Ankara'da Çakıl için minimum sipariş miktarı nedir?",
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  { name: "Ana Sayfa", url: "/" },
  { name: "Çakıl Taşıma", url: "/malzeme/cakil" },
  { name: "Ankara Çakıl Taşıma", url: "/malzeme/cakil/ankara" },
]);

const faqJsonLd = buildFaqJsonLd(comboFaq);


const MalzemeCakilAnkara = () => {
  const localBusinessJsonLd = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "Hammaddem – Ankara Çakıl Tedariği",
    description,
    url: canonical,
  ...
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Ankara Çakıl Satış & Teslimat",
    description,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="ankara çakıl, çakıl ankara, ankara cakil fiyatı, iri çakıl, ince çakıl" />
      ...
      <div className="min-h-screen bg-dot-pattern">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(28px,4vw,46px)] font-extrabold tracking-tight leading-[1.1] mb-5">
                  Ankara&apos;da Çakıl Satış & Teslimat
                </h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  Ankara'da çakıl satış ve teslimat için Hammaddem'i tercih edin. OSB, Ostim ve sanayi bölgelerine çakıl teslimatı yapıyoruz. Ton bazında rekabetçi fiyat için 30 dakika içinde teklif alın.
                </p>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">
              Ankara&apos;da Çakıl Satış & Teslimat Nasıl Çalışır?
            </h2>
            <div className="prose prose-sm max-w-none text-txt-2 leading-[1.8] space-y-4">
              <p>
                Ankara&apos;da çakıl satış ve teslimat için Hammaddem platformunu kullanın.
                OSB, Ostim ve sanayi bölgelerine çakıl teslimatı gerçekleştiriyoruz.
        ...
        <section className="py-16 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-10">
              Ankara&apos;da Çakıl İçin Neden Hammaddem?
            </h2>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-3">Ankara Çakıl Taşıma Hakkında Sık Sorulan Sorular</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <a key="kocaeli" href="/malzeme/cakil/kocaeli" className="px-3 py-1.5 rounded-full text-xs font-medium bg-background border border-border hover:border-accent-border hover:text-primary transition-colors no-underline">Kocaeli</a>
                </div>
              </div>
              <div>
...
export default MalzemeCakilAnkara;
