...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  { name: "Ana Sayfa", url: "/" },
  { name: "Hizmet Bölgeleri", url: "/hizmet-bolgeleri/balikesir" },
  { name: "Balıkesir Silobas Nakliye & Hammadde Teslimatı", url: "/hizmet-bolgeleri/balikesir" },
]);

const BolgeBalikesir = () => {
  const digerSehirler = BOLGE_ROUTES.filter((r) => r.path !== "/hizmet-bolgeleri/balikesir");

  const localBusinessJsonLd = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "Hammaddem – Balıkesir Silobas Nakliye & Hammadde Teslimatı",
    description,
    url: canonical,
    telephone: "+905393308617",
    areaServed: { "@type": "City", name: "Balıkesir", containedInPlace: { "@type": "Country", name: "Türkiye" } },
  };

  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Balıkesir Silobas Nakliye ve Hammadde Teslimatı",
    description,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="balıkesir silobas, silobas balıkesir, balıkesir silobas nakliye, balıkesir çimento, balıkesir kum fiyatları, balıkesir çakıl, balıkesir mıcır, balıkesir hammadde teslimatı" />
        ...
        <meta property="og:image" content="https://hammaddem.co/og/il-balikesir.jpg" />
      ...
      <div className="min-h-screen bg-dot-pattern">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(30px,4vw,48px)] font-extrabold tracking-tight leading-[1.1] mb-5">
                  Balıkesir Silobas Nakliye ve Hammadde Teslimatı
                </h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  Balıkesir'de silobas nakliye ve hammadde teslimatı: dökme çimento, kalsit, kum, çakıl, mıcır. Bandırma, Gönen ve sanayi bölgelerine teslimat, 30 dk teklif.
                </p>
                ...
                <p className="mt-5 text-sm text-txt-2">
                  ...
                  <Link to="/hafriyat/balikesir" className="font-semibold text-navy no-underline hover:underline">
                    Balıkesir hafriyat firması sayfası →
                  </Link>
                </p>
              </div>
              <HeroGorsel priority src="/images/il-balikesir.webp" alt="Balıkesir zeytinlikleri arasında kırsal yolda damperli kamyon" />
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">Balıkesir&apos;de Hizmetlerimiz</h2>
            <div className="prose prose-sm max-w-none text-txt-2 leading-[1.8] space-y-4">
              <p>Balıkesir, Marmara ve Ege bölgeleri arasında köprü görevi gören stratejik konumuyla tarım, madencilik ve gıda sanayi alanında öne çıkar. Bandırma Limanı Türkiye&apos;nin önemli ihracat kapılarından biridir. Balıkesir OSB, Bandırma OSB ve Gönen Sanayi Sitesi başta olmak üzere bölgedeki sanayi tesislerine çimento, kalsit, kireç, alçı, mermer tozu ve uçucu kül silobas taşımacılığı yapıyoruz.</p>
              <p>Balıkesir&apos;in zengin doğal kaynak yapısı ve aktif madencilik sektörü sayesinde kum, çakıl, mıcır ve stabilize malzeme tedariğinde güçlü bir ağa sahibiz. Bandırma, Gönen, Erdek ve Edremit ilçelerine düzenli teslimat yapıyoruz.</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">Balıkesir Hizmet Detayı</h2>
            <div className="grid md:grid-cols-2 gap-5">
              <div className="border border-border rounded-2xl p-6 bg-background hover:border-accent-border transition-colors">
                ...
                <p className="text-sm text-txt-2 leading-relaxed mb-2">
                  Çimento, kalsit, uçucu kül, kireç, mermer tozu, alçı ve tüm toz/granül malzemeleri pnömatik silobas araçlarıyla Balıkesir genelinde teslim ediyoruz.
                </p>
                <p className="text-xs text-txt-2 leading-relaxed mb-3">
                  <strong>Hizmet bölgeleri:</strong> Balıkesir OSB, Bandırma OSB, Gönen Sanayi Sitesi
                </p>
              ...
              <div className="border border-border rounded-2xl p-6 bg-background hover:border-accent-border transition-colors">
                ...
                <p className="text-sm text-txt-2 leading-relaxed mb-2">
                  Kum, çakıl, mıcır, stabilize malzeme tedariği. Balıkesir ilçelerinde şantiye ve tesislere damperli araçlarla teslimat.
                </p>
                <p className="text-xs text-txt-2 leading-relaxed mb-3">
                  <strong>İlçeler:</strong> Bandırma, Gönen, Erdek, Edremit, Susurluk, Bigadiç
                </p>
                <Link to="/hafriyat/balikesir" className="inline-flex items-center gap-1 text-sm font-semibold text-primary mt-1 no-underline hover:underline">
                  Balıkesir hafriyat işleri: kazı, moloz <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-3">Balıkesir&apos;de Taşıdığımız Malzemeler</h2>
            <p className="text-sm text-txt-2 mb-8 max-w-[520px]">Detay ve fiyat için malzeme sayfasına tıklayın, Balıkesir&apos;e özel teklif alın.</p>
        ...
        <section className="py-16 md:py-20 px-4 md:px-10 bg-off">
          <div className="max-w-[700px] mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-4">Balıkesir İçin Teklif Alın</h2>
