...
const faq = [
  { q: "Çakıl ile mıcır arasındaki fark nedir?", a: "Çakıl genelde doğal (dere, deniz) veya kırma kökenli yuvarlak köşeli agrega; mıcır ise kırma taştan elde edilen keskin köşeli agregadır. Beton ve drenajda her ikisi de kullanılabilir; proje ihtiyacına göre seçim yapılır." },
  { q: "Hangi çakıl türlerini tedarik ediyorsunuz?", a: "Dere çakılı, inşaat çakılı ve kırma çakıl tedarik ediyoruz. Boyut sınıflarına göre (örn. 5–12 mm, 12–22 mm) sipariş verebilirsiniz. Detay ve fiyat için teklif almanızı öneririz." },
  { q: "Çakıl teslimatı nasıl yapılıyor?", a: "Çakıl, damperli kamyonlarla şantiye veya belirttiğiniz adrese boşaltılır. Miktar (m³ veya ton) ve mesafeye göre araç sayısı planlanır. Talep formundan teklif alabilirsiniz." },
  { q: "Peyzaj ve drenaj için uygun mu?", a: "Evet. Çakıl peyzaj düzenlemesi, drenaj katmanları, bahçe yolları ve filtre dolgusu için yaygın kullanılır. İhtiyacınıza uygun boyut ve tür için teklif alabilirsiniz." },
];
      ...
      <div className="min-h-screen bg-dot-pattern">
          ...
          <div className="max-w-[1100px] mx-auto">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(30px,4vw,48px)] font-extrabold tracking-tight leading-[1.1] mb-5">Çakıl Satış & Teslimat</h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  İnşaat çakılı, dere çakılı ve kırma çakıl satışı ile beton, drenaj ve peyzaj ihtiyaçlarınızı karşılıyoruz. Toptan çakıl tedariği, 11 ilde hızlı teslimat. Online teklif alarak m³ veya ton bazında sipariş verebilirsiniz.
                </p>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            ...
            <div className="prose prose-sm max-w-none text-txt-2 leading-[1.8] space-y-4">
              <p>
                Çakıl, doğal veya kırma kökenli iri agrega sınıfına giren bir inşaat malzemesidir. Dere çakılı (yuvarlak, doğal), inşaat çakılı ve kırma çakıl olarak türlere ayrılır. Boyut sınıfları (ör. 5–12 mm, 12–22 mm) beton, drenaj ve peyzaj uygulamalarına göre seçilir.
              </p>
              <p>
                Beton üretiminde kum ve çimento ile karıştırılarak dayanıklı yapı malzemesi elde edilir; drenaj katmanları ve peyzaj düzenlemesinde de yaygın kullanılır. Hammaddem ile toptan çakıl tedariği, 11 ilde hızlı teslimat ve rekabetçi fiyatlarla sunulur.
              </p>
              <p>
                Miktar (m³ veya ton), çakıl türü ve teslimat adresinize göre anında teklif alabilirsiniz. Şantiye veya tesis teslimatı için talep formunu doldurmanız yeterlidir.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {["Beton ve hazır beton üretimi", "Drenaj ve filtre katmanları", "Peyzaj ve bahçe düzenlemesi", "Yol alt yapı dolgusu", "Briket ve blok üretimi", "Filtre ve arıtma tesisleri"].map((m) => (
        ...
        <section className="py-16 md:py-20 px-4 md:px-10">
          <div className="max-w-[700px] mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-4">Çakıl İçin Teklif Alın</h2>
