...
const comboFaq = [
  {
    "q": "Bursa'da Kum silobas taşıma nasıl çalışır?",
  ...
  {
    "q": "Bursa'da Kum için minimum sipariş miktarı nedir?",
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Bursa Kum Taşıma", url: "/malzeme/kum/bursa" },
]);
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-dot-pattern">
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-3">Bursa Kum Taşıma Hakkında Sık Sorulan Sorular</h2>
