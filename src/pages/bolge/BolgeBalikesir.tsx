...
const title = "Balıkesir Silobas & Hafriyat Hizmetleri – Hammaddem";
const description = "Balıkesir'de silobas taşımacılığı ve hafriyat malzemesi tedariği. Bandırma, Gönen ve sanayi bölgelerine hızlı teslimat. Online teklif alın.";
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Balıkesir Silobas & Hafriyat", url: "/hizmet-bolgeleri/balikesir" },
]);
...
const BolgeBalikesir = () => {
  ...
  const localBusinessJsonLd = {
    ...
    "@type": "LocalBusiness",
    name: "Hammaddem – Balıkesir Silobas & Hafriyat",
    description,
    url: canonical,
  ...
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Balıkesir Silobas ve Hafriyat Hizmetleri",
    description,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="balıkesir silobas, balıkesir hafriyat, balıkesir çimento, bandırma kum, balıkesir çakıl, silobas balıkesir" />
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(30px,4vw,48px)] font-extrabold tracking-tight leading-[1.1] mb-5">
                  Balıkesir Silobas & Hafriyat
                </h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  Balıkesir&apos;de silobas taşımacılığı ve hafriyat malzemesi tedariği. Bandırma, Gönen ve sanayi bölgelerine hızlı teslimat. Online teklif alın.
                </p>
