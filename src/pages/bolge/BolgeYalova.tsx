...
const title = "Yalova Silobas & Hafriyat Hizmetleri – Hammaddem";
const description = "Yalova'da silobas taşımacılığı ve hafriyat malzemesi tedariği. Sanayi bölgeleri ve inşaat projelerine hızlı teslimat. Online teklif alın.";
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Yalova Silobas & Hafriyat", url: "/hizmet-bolgeleri/yalova" },
]);
...
const BolgeYalova = () => {
  ...
  const localBusinessJsonLd = {
    ...
    "@type": "LocalBusiness",
    name: "Hammaddem – Yalova Silobas & Hafriyat",
    description,
    url: canonical,
  ...
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Yalova Silobas ve Hafriyat Hizmetleri",
    description,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="yalova silobas, yalova hafriyat, yalova çimento, yalova kum, yalova çakıl, silobas yalova" />
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(30px,4vw,48px)] font-extrabold tracking-tight leading-[1.1] mb-5">
                  Yalova Silobas & Hafriyat
                </h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  Yalova&apos;da silobas taşımacılığı ve hafriyat malzemesi tedariği. Sanayi bölgeleri ve inşaat projelerine hızlı teslimat. Online teklif alın.
                </p>
