...
const canonical = "https://hammaddem.co/malzeme/cakil/istanbul";
const title = "İstanbul Çakıl Satış & Teslimat | Hammaddem";
const description = "İstanbul'da çakıl satış ve teslimat. Avrupa ve Anadolu yakasında, sanayi bölgeleri ve OSB'lere hızlı teslimat. Ton bazında rekabetçi fiyat, 30 dakikada online teklif alın.";

const comboFaq = [
  {
    "q": "İstanbul'da Çakıl silobas taşıma nasıl çalışır?",
  ...
  {
    "q": "İstanbul'da Çakıl için minimum sipariş miktarı nedir?",
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "İstanbul Çakıl Taşıma", url: "/malzeme/cakil/istanbul" },
]);

const faqJsonLd = buildFaqJsonLd(comboFaq);


const MalzemeCakilIstanbul = () => {
  const localBusinessJsonLd = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "Hammaddem – İstanbul Çakıl Tedariği",
    description,
    url: canonical,
  ...
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "İstanbul Çakıl Satış & Teslimat",
    description,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="i̇stanbul çakıl, çakıl i̇stanbul, i̇stanbul cakil fiyatı, iri çakıl, ince çakıl" />
      ...
      <div className="min-h-screen bg-dot-pattern">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(28px,4vw,46px)] font-extrabold tracking-tight leading-[1.1] mb-5">
                  İstanbul&apos;da Çakıl Satış & Teslimat
                </h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  İstanbul'da çakıl satış ve teslimat için Hammaddem'i tercih edin. Avrupa ve Anadolu yakasında, sanayi bölgeleri ve OSB'lere çakıl teslimatı yapıyoruz. Ton bazında rekabetçi fiyat için 30 dakika içinde teklif alın.
                </p>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">
              İstanbul&apos;da Çakıl Satış & Teslimat Nasıl Çalışır?
            </h2>
            <div className="prose prose-sm max-w-none text-txt-2 leading-[1.8] space-y-4">
              <p>
                İstanbul&apos;da çakıl satış ve teslimat için Hammaddem platformunu kullanın.
                Avrupa ve Anadolu yakasında, sanayi bölgeleri ve OSB'lere çakıl teslimatı gerçekleştiriyoruz.
        ...
        <section className="py-16 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-10">
              İstanbul&apos;da Çakıl İçin Neden Hammaddem?
            </h2>
        ...
        <section className="py-16 md:py-20 px-4 md:px-10 bg-off">
          <div className="max-w-[700px] mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-4">
              İstanbul Çakıl İçin Teklif Alın
            </h2>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-3">İstanbul Çakıl Taşıma Hakkında Sık Sorulan Sorular</h2>
...
export default MalzemeCakilIstanbul;
