...
const MalzemeUcucuKulKocaeli = () => {
  const localBusinessJsonLd = {
    ...
    "@type": "LocalBusiness",
    name: "Hammaddem – Kocaeli Uçucu Kül Tedariği",
    description,
    url: canonical,
  ...
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Kocaeli Uçucu Kül Silobas Taşıma",
    description,
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(28px,4vw,46px)] font-extrabold tracking-tight leading-[1.1] mb-5">
                  Kocaeli&apos;da Uçucu Kül Silobas Taşıma
                </h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  Kocaeli'da uçucu kül silobas taşıma için Hammaddem'i tercih edin. Gebze, Dilovası, GOSB ve Kocaeli genelinde uçucu kül teslimatı yapıyoruz. Ton bazında rekabetçi fiyat için 30 dakika içinde teklif alın.
                </p>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">
              Kocaeli&apos;da Uçucu Kül Silobas Taşıma Nasıl Çalışır?
            </h2>
            <div className="prose prose-sm max-w-none text-txt-2 leading-[1.8] space-y-4">
              <p>
                Kocaeli&apos;da uçucu kül silobas taşıma için Hammaddem platformunu kullanın.
                Gebze, Dilovası, GOSB ve Kocaeli genelinde uçucu kül teslimatı gerçekleştiriyoruz.
        ...
        <section className="py-16 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-10">
              Kocaeli&apos;da Uçucu Kül İçin Neden Hammaddem?
            </h2>
        ...
        <section className="py-16 md:py-20 px-4 md:px-10 bg-off">
          <div className="max-w-[700px] mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-4">
              Kocaeli Uçucu Kül İçin Teklif Alın
            </h2>
...
export default MalzemeUcucuKulKocaeli;
