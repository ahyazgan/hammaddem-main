...
const title = "İstanbul Silobas & Hafriyat Hizmetleri – Hammaddem";
const description = "İstanbul'da silobas taşımacılığı ve hafriyat malzemesi tedariği. Avrupa ve Anadolu yakasında aynı gün teslimat. Online teklif alın.";
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "İstanbul Silobas & Hafriyat", url: "/hizmet-bolgeleri/istanbul" },
]);
...
const BolgeIstanbul = () => {
  ...
  const localBusinessJsonLd = {
    ...
    "@type": "LocalBusiness",
    name: "Hammaddem – İstanbul Silobas & Hafriyat",
    description,
    url: canonical,
  ...
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "İstanbul Silobas ve Hafriyat Hizmetleri",
    description,
