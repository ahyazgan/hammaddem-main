...
const description = "Mermer tozu silobas taşımacılığı. Mikronize mermer tozu tedariği, boya ve plastik sektörü. Online teklif alın.";

const avantajlar = [
  { icon: Clock, title: "30 Dakikada Teklif", desc: "Online talep formunu doldur, 30 dakika içinde rekabetçi fiyat teklifi al." },
  { icon: Shield, title: "Güvenli Taşıma", desc: "Pnömatik silobas ile mermer tozu tozlanma ve fire riski minimuma iner." },
...
const faq = [
  { q: "Mermer tozu nasıl üretilir?", a: "Mermer tozu, mermer bloklarının veya atıklarının kırılıp öğütülmesiyle elde edilir. Mikronize mermer tozu belirli mikron boyutlarında (örn. 5–45 mikron) öğütülerek boya, plastik ve kağıt sektöründe dolgu maddesi olarak kullanılır." },
  { q: "Mermer tozu hangi sektörlerde kullanılır?", a: "Boya, plastik, kağıt, kozmetik ve inşaat sektöründe dolgu ve beyazlık artırıcı olarak kullanılır. Yüzey kaplama, mastik ve macun üretiminde de tercih edilir." },
  { q: "Mermer tozu silobas ile nasıl taşınır?", a: "Mermer tozu pnömatik silobas araçlarıyla taşınır. Boşaltma silo veya depoya hava basıncı ile aktarılır. Talep oluşturarak miktar ve teslimat adresinize göre teklif alabilirsiniz." },
  { q: "Mikronize mermer tozu ne demek?", a: "Mikronize mermer tozu, mikron (µm) boyutlarında ince öğütülmüş mermer tozudur. Boya ve plastikte dolgu, yüzey düzgünlüğü ve maliyet optimizasyonu için kullanılır." },
];
...
const MalzemeMermerTozu = () => {
  ...
  const serviceJsonLd = {
    ...
    "@type": "Service",
    name: "Mermer Tozu Silobas Taşıma ve Tedariği",
    description,
      ...
      <div className="min-h-screen bg-dot-pattern">
          ...
          <div className="max-w-[1100px] mx-auto">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(30px,4vw,48px)] font-extrabold tracking-tight leading-[1.1] mb-5">Mermer Tozu Silobas Taşıma & Tedarik</h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  Mermer tozu silobas taşımacılığı ve mikronize mermer tozu tedariği ile boya ve plastik sektörünün ihtiyacını karşılıyoruz. Dolgu maddesi olarak 11 ilde teslimat, online teklif alın.
                </p>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            ...
            <div className="prose prose-sm max-w-none text-txt-2 leading-[1.8] space-y-4">
              <p>
                Mermer tozu, mermer bloklarının veya mermer atıklarının kırılıp öğütülmesiyle elde edilen kalsiyum karbonat (CaCO₃) kökenli ince tozdur. Mikronize mermer tozu, belirli mikron boyutlarında (örn. 5–45 mikron) öğütülerek boya, plastik, kağıt ve kozmetik sektöründe dolgu maddesi olarak kullanılır. Beyazlık ve yüzey düzgünlüğü sağlar.
              </p>
              <p>
                Boya sanayisinde hacim artırıcı, plastikte dolgu ve maliyet düşürücü, mastik ve macun üretiminde katkı olarak tercih edilir. Hammaddem ile mermer tozu silobas taşımacılığı, 11 ilde güvenli teslimat ile sunulur.
              </p>
              <p>
                İhtiyacınıza uygun mikron aralığı ve miktar için talep oluşturarak teklif alabilirsiniz. Ton bazında tedarik ve teslimat adresinize göre fiyatlandırma yapılır.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {["Boya ve boya katkıları", "Plastik ve kompozit dolgu", "Kağıt kaplama ve dolgu", "Mastik ve macun üretimi", "Kozmetik ve kişisel bakım", "İnşaat ve yüzey kaplama"].map((m) => (
        ...
        <section className="py-16 md:py-20 px-4 md:px-10">
          <div className="max-w-[700px] mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-4">Mermer Tozu İçin Teklif Alın</h2>
