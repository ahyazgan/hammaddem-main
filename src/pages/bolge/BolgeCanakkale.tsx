...
const BolgeCanakkale = () => {
  const digerSehirler = BOLGE_ROUTES.filter((r) => r.path !== "/hizmet-bolgeleri/canakkale");
  ...
  const localBusinessJsonLd = {
    ...
    areaServed: { "@type": "City", name: "Çanakkale", containedInPlace: { "@type": "Country", name: "Türkiye" } },
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:image" content="https://hammaddem.co/og/il-canakkale.jpg" />
      ...
      <div className="min-h-screen bg-dot-pattern">
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">Çanakkale&apos;de Hizmetlerimiz</h2>
            <div className="prose prose-sm max-w-none text-txt-2 leading-[1.8] space-y-4">
              <p>Çanakkale, 1915 Çanakkale Köprüsü ile Marmara ve Ege bölgelerini birbirine bağlayan önemli bir lojistik geçiş noktasıdır. Biga OSB, Çan Sanayi Bölgesi ve Lapseki sanayi alanlarına çimento, kalsit, kireç, alçı, mermer tozu ve uçucu kül silobas taşımacılığı yapıyoruz. Madencilik, seramik ve gıda sektörlerine düzenli malzeme tedariği sağlıyoruz.</p>
              <p>Çanakkale&apos;nin zengin maden yatakları ve aktif inşaat projeleri ile kum, çakıl, mıcır ve stabilize malzeme tedariğinde güvenilir çözüm sunuyoruz. Biga, Çan, Ezine, Gelibolu ve Lapseki ilçelerine aynı gün veya ertesi gün teslimat yapıyoruz.</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">Çanakkale Hizmet Detayı</h2>
            <div className="grid md:grid-cols-2 gap-5">
              <div className="border border-border rounded-2xl p-6 bg-background hover:border-accent-border transition-colors">
                ...
                <p className="text-sm text-txt-2 leading-relaxed mb-2">
                  Çimento, kalsit, uçucu kül, kireç, mermer tozu, alçı ve tüm toz/granül malzemeleri pnömatik silobas araçlarıyla Çanakkale genelinde teslim ediyoruz.
                </p>
                <p className="text-xs text-txt-2 leading-relaxed mb-3">
                  <strong>Hizmet bölgeleri:</strong> Biga OSB, Çan Sanayi Bölgesi, Lapseki
                </p>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-3">Çanakkale&apos;de Taşıdığımız Malzemeler</h2>
            <p className="text-sm text-txt-2 mb-8 max-w-[520px]">Detay ve fiyat için malzeme sayfasına tıklayın, Çanakkale&apos;ye özel teklif alın.</p>
        ...
        <section className="py-16 md:py-20 px-4 md:px-10 bg-off">
          <div className="max-w-[700px] mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-4">Çanakkale İçin Teklif Alın</h2>
