...
const canonical = "https://hammaddem.co/malzeme/alci/ankara";
const title = "Ankara Alçı Silobas Taşıma | Hammaddem";
const description = "Ankara'da alçı silobas taşıma. OSB, Ostim ve sanayi bölgelerine hızlı teslimat. Ton bazında rekabetçi fiyat, 30 dakikada online teklif alın.";

const comboFaq = [
  {
    "q": "Ankara'da Alçı silobas taşıma nasıl çalışır?",
  ...
  {
    "q": "Ankara'da Alçı için minimum sipariş miktarı nedir?",
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  { name: "Ana Sayfa", url: "/" },
  { name: "Alçı Taşıma", url: "/malzeme/alci" },
  { name: "Ankara Alçı Taşıma", url: "/malzeme/alci/ankara" },
]);

const faqJsonLd = buildFaqJsonLd(comboFaq);


const MalzemeAlciAnkara = () => {
  const localBusinessJsonLd = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "Hammaddem – Ankara Alçı Tedariği",
    description,
    url: canonical,
  ...
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Ankara Alçı Silobas Taşıma",
    description,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="ankara alçı, alçı ankara, ankara alci fiyatı, inşaat alçısı, sıva alçısı" />
      ...
      <div className="min-h-screen bg-dot-pattern">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(28px,4vw,46px)] font-extrabold tracking-tight leading-[1.1] mb-5">
                  Ankara&apos;da Alçı Silobas Taşıma
                </h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  Ankara'da alçı silobas taşıma için Hammaddem'i tercih edin. OSB, Ostim ve sanayi bölgelerine alçı teslimatı yapıyoruz. Ton bazında rekabetçi fiyat için 30 dakika içinde teklif alın.
                </p>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">
              Ankara&apos;da Alçı Silobas Taşıma Nasıl Çalışır?
            </h2>
            <div className="prose prose-sm max-w-none text-txt-2 leading-[1.8] space-y-4">
              <p>
                Ankara&apos;da alçı silobas taşıma için Hammaddem platformunu kullanın.
                OSB, Ostim ve sanayi bölgelerine alçı teslimatı gerçekleştiriyoruz.
                Online talep formunu doldurarak 30 dakika içinde size özel fiyat teklifi alabilirsiniz.
              </p>
              <p>
                Alçı silobas taşıma sürecinde araç planlaması, teslimat zamanlaması ve
              ...
              <p>
                Ton bazında rekabetçi alçı fiyatları için hemen kayıt olun ve teklif alın.
        ...
        <section className="py-16 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-10">
              Ankara&apos;da Alçı İçin Neden Hammaddem?
            </h2>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-3">Ankara Alçı Taşıma Hakkında Sık Sorulan Sorular</h2>
        ...
        <section className="py-10 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-xs font-semibold text-txt-2 uppercase tracking-wider mb-3">Alçı — Diğer Şehirler</h3>
                <div className="flex flex-wrap gap-2">
                  <a key="istanbul" href="/malzeme/alci/istanbul" className="px-3 py-1.5 rounded-full text-xs font-medium bg-background border border-border hover:border-accent-border hover:text-primary transition-colors no-underline">İstanbul</a>
                  <a key="izmir" href="/malzeme/alci/izmir" className="px-3 py-1.5 rounded-full text-xs font-medium bg-background border border-border hover:border-accent-border hover:text-primary transition-colors no-underline">İzmir</a>
...
export default MalzemeAlciAnkara;
