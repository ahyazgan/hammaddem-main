...
const canonical = "https://hammaddem.co/malzeme/alci/bursa";
const title = "Bursa Alçı Silobas Taşıma | Hammaddem";
const description = "Bursa'da alçı silobas taşıma. DOSAB, NOSAB, Nilüfer OSB ve Bursa genelinde hızlı teslimat. Ton bazında rekabetçi fiyat, 30 dakikada online teklif alın.";

const comboFaq = [
  {
    "q": "Bursa'da Alçı silobas taşıma nasıl çalışır?",
  ...
  {
    "q": "Bursa'da Alçı için minimum sipariş miktarı nedir?",
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Bursa Alçı Taşıma", url: "/malzeme/alci/bursa" },
]);

const faqJsonLd = buildFaqJsonLd(comboFaq);


const MalzemeAlciBursa = () => {
  const localBusinessJsonLd = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "Hammaddem – Bursa Alçı Tedariği",
    description,
    url: canonical,
  ...
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Bursa Alçı Silobas Taşıma",
    description,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="bursa alçı, alçı bursa, bursa alci fiyatı, inşaat alçısı, sıva alçısı" />
      ...
      <div className="min-h-screen bg-dot-pattern">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(28px,4vw,46px)] font-extrabold tracking-tight leading-[1.1] mb-5">
                  Bursa&apos;da Alçı Silobas Taşıma
                </h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  Bursa'da alçı silobas taşıma için Hammaddem'i tercih edin. DOSAB, NOSAB, Nilüfer OSB ve Bursa genelinde alçı teslimatı yapıyoruz. Ton bazında rekabetçi fiyat için 30 dakika içinde teklif alın.
                </p>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">
              Bursa&apos;da Alçı Silobas Taşıma Nasıl Çalışır?
            </h2>
            <div className="prose prose-sm max-w-none text-txt-2 leading-[1.8] space-y-4">
              <p>
                Bursa&apos;da alçı silobas taşıma için Hammaddem platformunu kullanın.
                DOSAB, NOSAB, Nilüfer OSB ve Bursa genelinde alçı teslimatı gerçekleştiriyoruz.
        ...
        <section className="py-16 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-10">
              Bursa&apos;da Alçı İçin Neden Hammaddem?
            </h2>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-3">Bursa Alçı Taşıma Hakkında Sık Sorulan Sorular</h2>
...
export default MalzemeAlciBursa;
