...
const canonical = "https://hammaddem.co/malzeme/kum/ankara";
const title = "Ankara Kum Satış & Teslimat | Hammaddem";
const description = "Ankara'da kum satış ve teslimat. OSB, Ostim ve sanayi bölgelerine hızlı teslimat. Ton bazında rekabetçi fiyat, 30 dakikada online teklif alın.";

const comboFaq = [
  {
    "q": "Ankara'da Kum silobas taşıma nasıl çalışır?",
  ...
  {
    "q": "Ankara'da Kum için minimum sipariş miktarı nedir?",
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Ankara Kum Taşıma", url: "/malzeme/kum/ankara" },
]);

const faqJsonLd = buildFaqJsonLd(comboFaq);


const MalzemeKumAnkara = () => {
  const localBusinessJsonLd = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "Hammaddem – Ankara Kum Tedariği",
    description,
    url: canonical,
  ...
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Ankara Kum Satış & Teslimat",
    description,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="ankara kum, kum ankara, ankara kum fiyatı, dere kumu, beton kumu" />
      ...
      <div className="min-h-screen bg-dot-pattern">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(28px,4vw,46px)] font-extrabold tracking-tight leading-[1.1] mb-5">
                  Ankara&apos;da Kum Satış & Teslimat
                </h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  Ankara'da kum satış ve teslimat için Hammaddem'i tercih edin. OSB, Ostim ve sanayi bölgelerine kum teslimatı yapıyoruz. Ton bazında rekabetçi fiyat için 30 dakika içinde teklif alın.
                </p>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">
              Ankara&apos;da Kum Satış & Teslimat Nasıl Çalışır?
            </h2>
            <div className="prose prose-sm max-w-none text-txt-2 leading-[1.8] space-y-4">
              <p>
                Ankara&apos;da kum satış ve teslimat için Hammaddem platformunu kullanın.
                OSB, Ostim ve sanayi bölgelerine kum teslimatı gerçekleştiriyoruz.
        ...
        <section className="py-16 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-10">
              Ankara&apos;da Kum İçin Neden Hammaddem?
            </h2>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-3">Ankara Kum Taşıma Hakkında Sık Sorulan Sorular</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <a key="bursa" href="/malzeme/kum/bursa" className="px-3 py-1.5 rounded-full text-xs font-medium bg-background border border-border hover:border-accent-border hover:text-primary transition-colors no-underline">Bursa</a>
...
export default MalzemeKumAnkara;
