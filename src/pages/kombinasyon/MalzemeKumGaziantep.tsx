...
const MalzemeKumGaziantep = () => {
  const localBusinessJsonLd = {
    ...
    "@type": "LocalBusiness",
    name: "Hammaddem – Gaziantep Kum Tedariği",
    description,
    url: canonical,
  ...
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Gaziantep Kum Satış & Teslimat",
    description,
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(28px,4vw,46px)] font-extrabold tracking-tight leading-[1.1] mb-5">
                  Gaziantep&apos;da Kum Satış & Teslimat
                </h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  Gaziantep'da kum satış ve teslimat için Hammaddem'i tercih edin. OSB ve sanayi bölgelerine kum teslimatı yapıyoruz. Ton bazında rekabetçi fiyat için 30 dakika içinde teklif alın.
                </p>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">
              Gaziantep&apos;da Kum Satış & Teslimat Nasıl Çalışır?
            </h2>
            <div className="prose prose-sm max-w-none text-txt-2 leading-[1.8] space-y-4">
              <p>
                Gaziantep&apos;da kum satış ve teslimat için Hammaddem platformunu kullanın.
                OSB ve sanayi bölgelerine kum teslimatı gerçekleştiriyoruz.
        ...
        <section className="py-16 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-10">
              Gaziantep&apos;da Kum İçin Neden Hammaddem?
            </h2>
        ...
        <section className="py-16 md:py-20 px-4 md:px-10 bg-off">
          <div className="max-w-[700px] mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-4">
              Gaziantep Kum İçin Teklif Alın
            </h2>
...
export default MalzemeKumGaziantep;
