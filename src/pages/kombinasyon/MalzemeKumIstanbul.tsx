...
const canonical = "https://hammaddem.co/malzeme/kum/istanbul";
const title = "İstanbul Kum Satış & Teslimat | Hammaddem";
const description = "İstanbul'da kum satış ve teslimat. Avrupa ve Anadolu yakasında, sanayi bölgeleri ve OSB'lere hızlı teslimat. Ton bazında rekabetçi fiyat, 30 dakikada online teklif alın.";

const comboFaq = [
  {
    "q": "İstanbul'da Kum silobas taşıma nasıl çalışır?",
  ...
  {
    "q": "İstanbul'da Kum için minimum sipariş miktarı nedir?",
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "İstanbul Kum Taşıma", url: "/malzeme/kum/istanbul" },
]);

const faqJsonLd = buildFaqJsonLd(comboFaq);


const MalzemeKumIstanbul = () => {
  const localBusinessJsonLd = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "Hammaddem – İstanbul Kum Tedariği",
    description,
    url: canonical,
  ...
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "İstanbul Kum Satış & Teslimat",
    description,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="i̇stanbul kum, kum i̇stanbul, i̇stanbul kum fiyatı, dere kumu, beton kumu" />
      ...
      <div className="min-h-screen bg-dot-pattern">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(28px,4vw,46px)] font-extrabold tracking-tight leading-[1.1] mb-5">
                  İstanbul&apos;da Kum Satış & Teslimat
                </h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  İstanbul'da kum satış ve teslimat için Hammaddem'i tercih edin. Avrupa ve Anadolu yakasında, sanayi bölgeleri ve OSB'lere kum teslimatı yapıyoruz. Ton bazında rekabetçi fiyat için 30 dakika içinde teklif alın.
                </p>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">
              İstanbul&apos;da Kum Satış & Teslimat Nasıl Çalışır?
            </h2>
            <div className="prose prose-sm max-w-none text-txt-2 leading-[1.8] space-y-4">
              <p>
                İstanbul&apos;da kum satış ve teslimat için Hammaddem platformunu kullanın.
                Avrupa ve Anadolu yakasında, sanayi bölgeleri ve OSB'lere kum teslimatı gerçekleştiriyoruz.
        ...
        <section className="py-16 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-10">
              İstanbul&apos;da Kum İçin Neden Hammaddem?
            </h2>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-3">İstanbul Kum Taşıma Hakkında Sık Sorulan Sorular</h2>
...
export default MalzemeKumIstanbul;
