...
const title = "Edirne Silobas & Hafriyat Hizmetleri – Hammaddem";
const description = "Edirne'de silobas taşımacılığı ve hafriyat malzemesi tedariği. Keşan, Uzunköprü ve sanayi bölgelerine hızlı teslimat. Online teklif alın.";
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Edirne Silobas & Hafriyat", url: "/hizmet-bolgeleri/edirne" },
]);
...
const BolgeEdirne = () => {
  ...
  const localBusinessJsonLd = {
    ...
    "@type": "LocalBusiness",
    name: "Hammaddem – Edirne Silobas & Hafriyat",
    description,
    url: canonical,
  ...
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Edirne Silobas ve Hafriyat Hizmetleri",
    description,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="edirne silobas, edirne hafriyat, edirne çimento, keşan kum, edirne çakıl, silobas edirne" />
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(30px,4vw,48px)] font-extrabold tracking-tight leading-[1.1] mb-5">
                  Edirne Silobas & Hafriyat
                </h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  Edirne&apos;de silobas taşımacılığı ve hafriyat malzemesi tedariği. Keşan, Uzunköprü ve sanayi bölgelerine hızlı teslimat. Online teklif alın.
                </p>
