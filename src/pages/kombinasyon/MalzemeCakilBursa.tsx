...
const canonical = "https://hammaddem.co/malzeme/cakil/bursa";
const title = "Bursa Çakıl Satış & Teslimat | Hammaddem";
const description = "Bursa'da çakıl satış ve teslimat. DOSAB, NOSAB, Nilüfer OSB ve Bursa genelinde hızlı teslimat. Ton bazında rekabetçi fiyat, 30 dakikada online teklif alın.";

const comboFaq = [
  {
    "q": "Bursa'da Çakıl silobas taşıma nasıl çalışır?",
  ...
  {
    "q": "Bursa'da Çakıl için minimum sipariş miktarı nedir?",
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Bursa Çakıl Taşıma", url: "/malzeme/cakil/bursa" },
]);

const faqJsonLd = buildFaqJsonLd(comboFaq);


const MalzemeCakilBursa = () => {
  const localBusinessJsonLd = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "Hammaddem – Bursa Çakıl Tedariği",
    description,
    url: canonical,
  ...
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Bursa Çakıl Satış & Teslimat",
    description,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="bursa çakıl, çakıl bursa, bursa cakil fiyatı, iri çakıl, ince çakıl" />
      ...
      <div className="min-h-screen bg-dot-pattern">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(28px,4vw,46px)] font-extrabold tracking-tight leading-[1.1] mb-5">
                  Bursa&apos;da Çakıl Satış & Teslimat
                </h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  Bursa'da çakıl satış ve teslimat için Hammaddem'i tercih edin. DOSAB, NOSAB, Nilüfer OSB ve Bursa genelinde çakıl teslimatı yapıyoruz. Ton bazında rekabetçi fiyat için 30 dakika içinde teklif alın.
                </p>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">
              Bursa&apos;da Çakıl Satış & Teslimat Nasıl Çalışır?
            </h2>
            <div className="prose prose-sm max-w-none text-txt-2 leading-[1.8] space-y-4">
              <p>
                Bursa&apos;da çakıl satış ve teslimat için Hammaddem platformunu kullanın.
                DOSAB, NOSAB, Nilüfer OSB ve Bursa genelinde çakıl teslimatı gerçekleştiriyoruz.
        ...
        <section className="py-16 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-10">
              Bursa&apos;da Çakıl İçin Neden Hammaddem?
            </h2>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-3">Bursa Çakıl Taşıma Hakkında Sık Sorulan Sorular</h2>
...
export default MalzemeCakilBursa;
