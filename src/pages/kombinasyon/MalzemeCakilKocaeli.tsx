...
const comboFaq = [
  {
    "q": "Kocaeli'da Çakıl silobas taşıma nasıl çalışır?",
  ...
  {
    "q": "Kocaeli'da Çakıl için minimum sipariş miktarı nedir?",
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Kocaeli Çakıl Taşıma", url: "/malzeme/cakil/kocaeli" },
]);
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-dot-pattern">
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-3">Kocaeli Çakıl Taşıma Hakkında Sık Sorulan Sorular</h2>
