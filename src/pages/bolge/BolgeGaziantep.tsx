...
const canonical = "https://hammaddem.co/hizmet-bolgeleri/gaziantep";
const title = "Gaziantep Silobas & Hafriyat Hizmetleri – Hammaddem";
const description = "Gaziantep'te silobas taşımacılığı ve hafriyat tedariği. OSB ve sanayi bölgelerine hızlı teslimat. Online teklif alın.";
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Gaziantep Silobas & Hafriyat", url: "/hizmet-bolgeleri/gaziantep" },
]);

const BolgeGaziantep = () => {
  const digerSehirler = BOLGE_ROUTES.filter((r) => r.path !== "/hizmet-bolgeleri/gaziantep");

  const localBusinessJsonLd = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "Hammaddem – Gaziantep Silobas & Hafriyat",
    description,
    url: canonical,
  ...
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Gaziantep Silobas ve Hafriyat Hizmetleri",
    description,
