...
const canonical = "https://hammaddem.co/hizmet-bolgeleri/edirne";
const title = "Edirne Silobas Nakliye & Hammadde Teslimatı | Hammaddem";
const description = "Edirne'de silobas nakliye ve hammadde teslimatı: dökme çimento, kalsit, kum, çakıl, mıcır. Keşan, Uzunköprü ve sanayi bölgelerine teslimat, 30 dk teklif.";
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  { name: "Ana Sayfa", url: "/" },
  { name: "Hizmet Bölgeleri", url: "/hizmet-bolgeleri/edirne" },
  { name: "Edirne Silobas Nakliye & Hammadde Teslimatı", url: "/hizmet-bolgeleri/edirne" },
]);

const BolgeEdirne = () => {
  const digerSehirler = BOLGE_ROUTES.filter((r) => r.path !== "/hizmet-bolgeleri/edirne");

  const localBusinessJsonLd = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "Hammaddem – Edirne Silobas Nakliye & Hammadde Teslimatı",
    description,
    url: canonical,
    telephone: "+905393308617",
    areaServed: { "@type": "City", name: "Edirne", containedInPlace: { "@type": "Country", name: "Türkiye" } },
  };

  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Edirne Silobas Nakliye ve Hammadde Teslimatı",
    description,
    provider: { "@type": "Organization", name: "Hammaddem" },
    areaServed: { "@type": "City", name: "Edirne" },
    url: canonical,
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="edirne silobas, silobas edirne, edirne silobas nakliye, edirne çimento, edirne kum fiyatları, edirne çakıl, edirne mıcır, edirne hammadde teslimatı" />
        ...
        <meta property="og:image" content="https://hammaddem.co/og/il-edirne.jpg" />
      ...
      <div className="min-h-screen bg-dot-pattern">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(30px,4vw,48px)] font-extrabold tracking-tight leading-[1.1] mb-5">
                  Edirne Silobas Nakliye ve Hammadde Teslimatı
                </h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  Edirne'de silobas nakliye ve hammadde teslimatı: dökme çimento, kalsit, kum, çakıl, mıcır. Keşan, Uzunköprü ve sanayi bölgelerine teslimat, 30 dk teklif.
                </p>
                ...
                <p className="mt-5 text-sm text-txt-2">
                  ...
                  <Link to="/hafriyat/edirne" className="font-semibold text-navy no-underline hover:underline">
                    Edirne hafriyat firması sayfası →
                  </Link>
                </p>
              </div>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">Edirne&apos;de Hizmetlerimiz</h2>
            <div className="prose prose-sm max-w-none text-txt-2 leading-[1.8] space-y-4">
              <p>Edirne, Türkiye&apos;nin Avrupa kapısı olarak sınır ticareti ve tarım sanayi alanında önemli bir merkezdir. Edirne OSB, Keşan OSB ve Uzunköprü Sanayi Sitesi başta olmak üzere bölgedeki tesislere çimento, kalsit, kireç, alçı, mermer tozu ve uçucu kül silobas taşımacılığı yapıyoruz. Gıda işleme, tarımsal sanayi ve inşaat sektörlerine düzenli malzeme tedariği sağlıyoruz.</p>
              <p>Trakya Otoyolu ve Tekirdağ-Edirne güzergahı üzerindeki konumuyla Edirne&apos;ye hızlı erişim sağlıyoruz. Kum, çakıl, mıcır ve stabilize malzeme tedariğinde Keşan, Uzunköprü, İpsala ve Havsa ilçelerine düzenli teslimat yapıyoruz.</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">Edirne Hizmet Detayı</h2>
            <div className="grid md:grid-cols-2 gap-5">
              <div className="border border-border rounded-2xl p-6 bg-background hover:border-accent-border transition-colors">
                ...
                <p className="text-sm text-txt-2 leading-relaxed mb-2">
                  Çimento, kalsit, uçucu kül, kireç, mermer tozu, alçı ve tüm toz/granül malzemeleri pnömatik silobas araçlarıyla Edirne genelinde teslim ediyoruz.
                </p>
                <p className="text-xs text-txt-2 leading-relaxed mb-3">
                  <strong>Hizmet bölgeleri:</strong> Edirne OSB, Keşan OSB, Uzunköprü Sanayi Sitesi
                </p>
              ...
              <div className="border border-border rounded-2xl p-6 bg-background hover:border-accent-border transition-colors">
                ...
                <p className="text-sm text-txt-2 leading-relaxed mb-2">
                  Kum, çakıl, mıcır, stabilize malzeme tedariği. Edirne ilçelerinde şantiye ve tesislere damperli araçlarla teslimat.
                </p>
                <p className="text-xs text-txt-2 leading-relaxed mb-3">
                  <strong>İlçeler:</strong> Keşan, Uzunköprü, İpsala, Havsa, Enez, Lalapaşa
                </p>
                <Link to="/hafriyat/edirne" className="inline-flex items-center gap-1 text-sm font-semibold text-primary mt-1 no-underline hover:underline">
                  Edirne hafriyat işleri: kazı, moloz <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-3">Edirne&apos;de Taşıdığımız Malzemeler</h2>
            <p className="text-sm text-txt-2 mb-8 max-w-[520px]">Detay ve fiyat için malzeme sayfasına tıklayın, Edirne&apos;ye özel teklif alın.</p>
        ...
        <section className="py-16 md:py-20 px-4 md:px-10 bg-off">
          <div className="max-w-[700px] mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-4">Edirne İçin Teklif Alın</h2>
