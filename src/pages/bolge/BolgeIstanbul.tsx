...
const canonical = "https://hammaddem.co/hizmet-bolgeleri/istanbul";
const title = "İstanbul Silobas Nakliye & Hammadde Teslimatı | Hammaddem";
const description = "İstanbul'da silobas nakliye ve hammadde teslimatı: dökme çimento, kalsit, kireç, kum, çakıl, mıcır. Avrupa ve Anadolu yakası şantiyelerine 30 dk teklif.";
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "İstanbul Silobas Nakliye & Hammadde Teslimatı", url: "/hizmet-bolgeleri/istanbul" },
]);

const BolgeIstanbul = () => {
  const digerSehirler = BOLGE_ROUTES.filter((r) => r.path !== "/hizmet-bolgeleri/istanbul");

  const localBusinessJsonLd = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "Hammaddem – İstanbul Silobas Nakliye & Hammadde Teslimatı",
    description,
    url: canonical,
  ...
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "İstanbul Silobas Nakliye ve Hammadde Teslimatı",
    description,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="istanbul silobas, silobas istanbul, istanbul silobas nakliye, istanbul çimento, istanbul kum fiyatları, istanbul çakıl, istanbul mıcır, istanbul hammadde teslimatı" />
        ...
        <meta property="og:image" content="https://hammaddem.co/og/il-istanbul.jpg" />
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(30px,4vw,48px)] font-extrabold tracking-tight leading-[1.1] mb-5">
                  İstanbul Silobas Nakliye ve Hammadde Teslimatı
                </h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  İstanbul'da silobas nakliye ve hammadde teslimatı: dökme çimento, kalsit, kireç, kum, çakıl, mıcır. Avrupa ve Anadolu yakası şantiyelerine 30 dk teklif.
                </p>
                ...
                <p className="mt-5 text-sm text-txt-2">
                  ...
                  <Link to="/hafriyat/istanbul" className="font-semibold text-navy no-underline hover:underline">
                    İstanbul hafriyat firması sayfası →
                  </Link>
                </p>
              </div>
              <HeroGorsel priority src="/images/il-istanbul.webp" alt="Boğaz ve köprü manzaralı yamaç yolunda damperli hafriyat kamyonu" />
            </div>
          </div>
        </section>
          ...
          <div className="max-w-[1100px] mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-5">
              ...
              <div className="border border-border rounded-2xl p-6 bg-background hover:border-accent-border transition-colors">
                ...
                <Link to="/hafriyat/istanbul" className="inline-flex items-center gap-1 text-sm font-semibold text-primary mt-1 no-underline hover:underline">
                  İstanbul hafriyat işleri: kazı, moloz <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>
          </div>
