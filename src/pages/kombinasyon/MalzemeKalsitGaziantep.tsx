...
const canonical = "https://hammaddem.co/malzeme/kalsit/gaziantep";
const title = "Gaziantep Kalsit Silobas Taşıma | Hammaddem";
const description = "Gaziantep'da kalsit silobas taşıma. OSB ve sanayi bölgelerine hızlı teslimat. Ton bazında rekabetçi fiyat, 30 dakikada online teklif alın.";

const comboFaq = [
  {
    "q": "Gaziantep'da Kalsit silobas taşıma nasıl çalışır?",
  ...
  {
    "q": "Gaziantep'da Kalsit için minimum sipariş miktarı nedir?",
...
const breadcrumbJsonLd = buildBreadcrumbJsonLd([
  ...
  { name: "Gaziantep Kalsit Taşıma", url: "/malzeme/kalsit/gaziantep" },
]);

const faqJsonLd = buildFaqJsonLd(comboFaq);


const MalzemeKalsitGaziantep = () => {
  const localBusinessJsonLd = {
    "@context": "https://schema.org",
    "@type": "LocalBusiness",
    name: "Hammaddem – Gaziantep Kalsit Tedariği",
    description,
    url: canonical,
  ...
  const serviceJsonLd = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Gaziantep Kalsit Silobas Taşıma",
    description,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="gaziantep kalsit, kalsit gaziantep, gaziantep kalsit fiyatı, kalsit tozu, kalsiyum karbonat" />
      ...
      <div className="min-h-screen bg-dot-pattern">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <h1 className="text-[clamp(28px,4vw,46px)] font-extrabold tracking-tight leading-[1.1] mb-5">
                  Gaziantep&apos;da Kalsit Silobas Taşıma
                </h1>
                <p className="text-base md:text-lg text-txt-2 leading-[1.7] mb-8 max-w-[500px]">
                  Gaziantep'da kalsit silobas taşıma için Hammaddem'i tercih edin. OSB ve sanayi bölgelerine kalsit teslimatı yapıyoruz. Ton bazında rekabetçi fiyat için 30 dakika içinde teklif alın.
                </p>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-6">
              Gaziantep&apos;da Kalsit Silobas Taşıma Nasıl Çalışır?
            </h2>
            <div className="prose prose-sm max-w-none text-txt-2 leading-[1.8] space-y-4">
              <p>
                Gaziantep&apos;da kalsit silobas taşıma için Hammaddem platformunu kullanın.
                OSB ve sanayi bölgelerine kalsit teslimatı gerçekleştiriyoruz.
        ...
        <section className="py-16 px-4 md:px-10">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-10">
              Gaziantep&apos;da Kalsit İçin Neden Hammaddem?
            </h2>
        ...
        <section className="py-16 md:py-20 px-4 md:px-10 bg-off">
          <div className="max-w-[700px] mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-4">
              Gaziantep Kalsit İçin Teklif Alın
            </h2>
        ...
        <section className="py-16 px-4 md:px-10 bg-off">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-3">Gaziantep Kalsit Taşıma Hakkında Sık Sorulan Sorular</h2>
...
export default MalzemeKalsitGaziantep;
